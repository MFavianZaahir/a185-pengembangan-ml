...
async function init(){
    ...
    model = await tf.loadLayersModel('http://127.0.0.1:5500/Tensorflow%20JS/a185-pengembangan-ml/sample_project_tfjs/solution/tfjs_model/model.json');
    isModelLoaded = true;

    //Memanggil word_index
    // const word_indexjson = await fetch('http://127.0.0.1:5500/word_index.json'); // Untuk VS Code Live Server
    const word_indexjson = await fetch('http://127.0.0.1:5500/Tensorflow%20JS/a185-pengembangan-ml/sample_project_tfjs/solution/word_index.json'); 
